  ...
  return (
    ...
    >
      ...
      <div className="dao-platform-head">
        ...
        <motion.h2 {...fadeUp(0.05)}>SOME TRUSTED PLATFORM WE WORK WITH.</motion.h2>
        <motion.p {...fadeUp(0.1)}>
          CRM, automation, project management, email, pipeline, and marketing platforms DEG connects into cleaner business systems.
        </motion.p>
      </div>
